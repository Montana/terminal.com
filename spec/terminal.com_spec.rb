    ...
    describe '.start_snapshot(user_token, access_token, snapshot_id, **options)' do
      ...
      context 'with given cpu and ram' do
        it 'should start given snapshot with cpu 2 (max) and ram 256' do
          ...
          sleep 16.5 unless File.exist?('spec/fixtures/start_snapshot_request_progress_valid_cpu_ram.yml')
        ...
        it 'should start given snapshot with cpu 200 and ram 3200' do
          ...
          sleep 16.5 unless File.exist?('spec/fixtures/start_snapshot_request_progress_valid_cpu_ram_2.yml')
      ...
      context 'with given name' do
        it 'should start given snapshot' do
          ...
          sleep 16.5 unless File.exist?('spec/fixtures/start_snapshot_request_progress_with_name.yml')
      ...
      context 'with autopause on' do
        it 'should start given snapshot' do
          ...
          sleep 16.5 unless File.exist?('spec/fixtures/start_snapshot_request_progress_with_autopause_on.yml')
      ...
      context 'with autopause off' do
        it 'should start given snapshot' do
          ...
          sleep 16.5 unless File.exist?('spec/fixtures/start_snapshot_request_progress_with_autopause_off.yml')
      ...
      context 'with temporary on' do
        it 'should start given snapshot' do
          ...
          sleep 16.5 unless File.exist?('spec/fixtures/start_snapshot_request_progress_with_temporary_on.yml')
      ...
      context 'with temporary off' do
        it 'should start given snapshot' do
          ...
          sleep 16.5 unless File.exist?('spec/fixtures/start_snapshot_request_progress_with_temporary_off.yml')
