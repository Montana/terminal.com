...
module Terminal
  ...
  # @see https://www.terminal.com/api/docs#get-snapshot Terminal.com API docs for this method
  ...
  # @see https://www.terminal.com/api/docs#get-profile Terminal.com API docs for this method
  ...
  # @see https://www.terminal.com/api/docs#list-public-snapshots Terminal.com API docs for this method
  # @example
  #   # Return all public snapshots.
  ...
  #
  #   # Return the first page of search results with 10 items per page, sorted by date.
  ...
  # @see https://www.terminal.com/api/docs#count-public-snapshots Terminal.com API docs for this method
  # @example
  ...
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#list-terminals Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#get-terminal Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#start-snapshot Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#delete-terminal Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#restart-terminal Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#pause-terminal Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#resume-terminal Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#edit-terminal Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#list-snapshots Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#count-snapshots Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#delete-snapshot Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#edit-snapshot Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#snapshot-terminal Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#add-terminal-links Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#remove-terminal-links Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#list-terminal-access Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#edit-terminal-access Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#get-cname-records Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#add-domain-to-pool Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#remove-domain-from-pool Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#add-cname-record Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#remove-cname-record Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#set-terminal-idle-settings Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#get-terminal-idle-settings Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#instance-types Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#instance-price Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#balance Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#balance-added Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#gift Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#burn-history Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#terminal-usage-history Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#burn-state Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#burn-estimates Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#add-authorized-key-to-terminal Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#add-authorized-key-to-ssh-proxy Terminal.com API docs for this method
  ...
  # @return [Hash] xxx
  # @see https://www.terminal.com/api/docs#del-authorized-key-from-ssh-proxy Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#get-authorized-keys-from-ssh-proxy Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#who-am-i Terminal.com API docs for this method
  ...
  # @param xxx [String] desc.
  # @return [Hash] desc.
  # @see https://www.terminal.com/api/docs#request-progress Terminal.com API docs for this method
